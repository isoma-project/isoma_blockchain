...
contract YourToken is ERC20, Ownable {
    ...
    address public marketingAndDevWallet = address(0x123); //your marketingAndDev wallet here
    address public stakingWallet = address(0x456); // your staking wallet here
    address public charityWallet = address(0x789); // your charity Wallet here
    ...
    uint256 public swapTokensAtAmount = (_totalSupply * 10) / 10000; // 0.1% of the supply (swap tokens greator than equal to this amount). 
